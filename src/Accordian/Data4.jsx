      ...
      <div className="p-4 text-sm">
        <div>
          ...
          <p>
            ...
            <span className="text-indigo-800 font-semibold">011-422 77777</span>
          </p>
        </div>
        ...
        <div className="mt-2  ">
          <table className="">
            <tr className="grid grid-cols-4 py-2 w-[670px] border rounded-md mb-4px text-gray-400 bg-slate-100">
              <th className="">Courier Partner</th>
              <th className="">Delivery Time</th>
              <th className="">Shipment Rate</th>
              <th className="">Select</th>
            </tr>
            <tr className=" grid grid-cols-4 px-12 py-4 mt-2  w-[670px] border rounded-md mb-4px text-gray-500x ">
        ...
        <div className="flex justify-end mt-8">
          {/* <button
            type="submit"
            className="px-4 py-2 bg-blue-900 text-gray-100 rounded-md font-bold text-[14px] hover:bg-blue-900 cursor-pointer"
          >
            Pay and Order
          </button> */}
          {/* <Button text={"Pay and Order"} /> */}
          <Button text={"Pay and Order"}  />
        </div>
      </div>
    </div>
